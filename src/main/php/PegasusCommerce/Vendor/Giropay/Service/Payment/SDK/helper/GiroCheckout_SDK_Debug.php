...
class GiroCheckout_SDK_Debug {
    ...
    */
    ...
    public function writeLog($string)
    {
        ...
        if(!is_dir($path)) {
        	if(!mkdir($path)) {        		
            	throw new GiroCheckout_SDK_Exception('Log directory does not exist. Please create directory: '.$path.'.');
        	}
        ...
        if(!self::$fp) {
	        ...
	        if(!self::$fp) throw new GiroCheckout_SDK_Exception('Log File ('.$path.self::$logFileName.') is not writeable.');
        }
